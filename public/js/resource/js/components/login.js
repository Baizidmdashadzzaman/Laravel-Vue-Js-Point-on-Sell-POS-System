...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)({
    incrementVuex: 'counter/increment',
    incrementVuex100: 'counter/increment100',
    decrementVuex: 'counter/decrement',
    decrementVuex100: 'counter/decrement100'
  })), {}, {
    incrementMeth: function incrementMeth() {
      this.incrementVuex();
      this.count = this.$store.state.counter.count;
    },
    incrementMeth100: function incrementMeth100() {
      this.incrementVuex100();
      this.count = this.$store.state.counter.count;
    },
    decrementMeth: function decrementMeth() {
      this.decrementVuex();
      this.count = this.$store.state.counter.count;
    },
    decrementMeth100: function decrementMeth100() {
      this.decrementVuex100();
      this.count = this.$store.state.counter.count;
    }
  })
});
          ...
          _c(
            ...
            [
              _c("h2", { staticClass: "text-center" }, [
                _vm._v("Laravel Vue Vuex Counter Application")
              ]),
              _vm._v(" "),
              _c("hr"),
              _vm._v(" "),
